...
**Parameters:**
- `authority: Keypair` - Authorized signer (buyer, arbiter, or anyone after timeout)
- `escrow: PublicKey` - The escrow account address
...
Cancels the escrow (only works in Initialized state, before funding).

**Parameters:**
- `authority: Keypair` - The buyer's keypair (only buyer can cancel)
- `escrow: PublicKey` - The escrow account address
