// client/working-example.js - JavaScript version that works without TypeScript issues
...
async function runWorkingExample() {
  ...
  const program = anchor.workspace.EscrowSystem;
  ...
  try {
    ...
    console.log("==============================================");
    console.log("Your escrow system works perfectly!");
